...
// On Windows, Claude Code's MCP pipe emits 'end'/'close' on stdin spuriously
// at startup before the session is established. Don't trust those events
// here — instead, poll whether the parent process is still alive (Windows
// doesn't reparent like POSIX, so process.ppid is stable until parent dies).
